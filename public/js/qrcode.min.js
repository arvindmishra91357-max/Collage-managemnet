/**
 * EasyQRCodeJS / QRCode.js standalone library
 * Standalone cross-browser QR code generator for Canvas, Image & SVG
 */
(function(window) {
  'use strict';
  ...
  // Main QRCode Object for Browser DOM
  ...
  QRCode.prototype.draw = function() {
    ...
    canvas.style.maxWidth = nWidth + "px";
